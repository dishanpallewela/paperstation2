...
public class CategoryRegistration extends javax.swing.JFrame {
   ...
   public void loadCategory() {
        ...
        try {
            ...
            ResultSet rs = MySQL.search("SELECT * FROM `product_category`");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs = MySQL.search("SELECT * FROM `product_category` WHERE `name`='" + name + "'");

                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Category already exsist", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
                    MySQL.iud("INSERT INTO `product_category`(`name`) VALUES('" + name + "')");
                    loadCategory();
